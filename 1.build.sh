...
docker_id="openeoe"
controller_name="openeoe-snapshot"
...
go build -o build/_output/bin/$controller_name -gcflags all=-trimpath=`pwd` -asmflags all=-trimpath=`pwd` -mod=vendor openeoe/openeoe/openeoe-snapshot/cmd/manager && \
